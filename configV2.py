...
DATASET_CONFIGS = {
    'alarm': {
        ...
        'data_path': NEURO_SYMBOLIC_DIR / 'data' / 'alarm' / 'alarm_data_10000.csv',
        # One-hot data for neural training (105 states)
    ...
    'insurance': {
        ...
        'data_path': NEURO_SYMBOLIC_DIR / 'data' / 'insurance' / 'insurance_data_10000.csv',
        # One-hot data for neural training (88 states)
    ...
    'tuebingen_pair0001': {
        ...
        'fci_data_path': NEURO_SYMBOLIC_DIR / 'data' / 'tuebingen' / 'pair0001' / 'pair0001_data_variable.csv',
        # For FCI (2 columns)
        'data_path': NEURO_SYMBOLIC_DIR / 'data' / 'tuebingen' / 'pair0001' / 'pair0001_data.csv',
        # For neural network (10 columns one-hot)
        ...
        'fci_skeleton_path': PROJECT_ROOT / 'refactored' / 'output' / 'tuebingen_pair0001' / 'edges_FCI_20251226_012031.csv',
        'llm_direction_path': PROJECT_ROOT / 'refactored' / 'output' / 'tuebingen_pair0001' / 'edges_FCI_LLM_GPT35_20251226_012044.csv',
    },
    ...
    'sachs': {
        ...
        'data_path': NEURO_SYMBOLIC_DIR / 'data' / 'sachs' / 'sachs_data.csv',
        # One-hot data for neural training (~33 states)
    ...
    'hailfinder': {
        ...
        'data_path': NEURO_SYMBOLIC_DIR / 'data' / 'hailfinder' / 'hailfinder_data.csv',
        # One-hot data for neural training (223 states)
    ...
    'win95pts': {
        ...
        'data_path': NEURO_SYMBOLIC_DIR / 'data' / 'win95pts' / 'win95pts_data.csv',
        # One-hot data for neural training (151 states)
    ...
    'andes': {
        ...
        'data_path': NEURO_SYMBOLIC_DIR / 'data' / 'andes' / 'andes_data.csv',
        # One-hot data for neural training (446 states)
