"""
Main Program: GPT-3.5 WITHOUT Chain-of-Thought
"""
...
class CausalDiscoveryPipeline:
    def __init__(self, data_loader, api_key, output_dir=None):
        ...
        print("Mode: WITHOUT Chain-of-Thought")
        print("=" * 60)
        ...
        print("[PROMPT] Using Direct prompting (NO Chain-of-Thought)")
    ...
    def run(self, max_steps=50, mi_threshold=0.05, significance_level=0.05):
        ...
        while step < max_steps:
            ...
            response = self.api_client.call(prompt, max_tokens=150)
...
def main():
    ...
    pipeline = CausalDiscoveryPipeline(data_loader, api_key)
    ...
    print("Compare with CoT version to see the difference!")
    print("=" * 60 + "\n")
