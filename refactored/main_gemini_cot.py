...
class CausalDiscoveryPipeline:
    def __init__(self, data_loader, api_key, model_name="models/gemini-2.0-flash-exp", output_dir=None):
        print("=" * 60)
...
def main():
    ...
    pipeline = CausalDiscoveryPipeline(data_loader, api_key, model_name)
